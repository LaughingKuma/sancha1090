...
-- Append-only serving exhaust: geometry stays out of silver/gold so guesses never
-- masquerade as conformed flight geometry; gold agg_est_* carry serving telemetry only.
