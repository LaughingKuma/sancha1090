...
# connection. ClickHouse has no multi-level catalog (catalog -> null); the aggregates/marts
# live in gold_ch, the lone silver fact in silver_ch.
EXPECTED_SCHEMA = {
...
# DATEADDs against. Values are UNCHANGED from the v2.7 Trino re-point.
EXPECTED_MAIN_DTTM = {
